...
case class TTUser(
                    id:Long, id_str: String, name: String, screen_name: String,
                    location: String, url: String, description: String, _protected: Boolean, createdAt: String,
...
object TTUser {
  ...
  implicit object TTUserFormat extends Format[TTUser] {
    ...
    def writes(user: TTUser): JsValue = JsObject(Seq(
      ...
      "created_at" -> JsString(user.createdAt),
